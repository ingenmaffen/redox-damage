...
fn handle_instruction(opcode: u8, cpu: &mut CPU, memory: &mut Memory) {
    ...
    match opcode {
        ...
        0xC0 => instructions::jump::ret_with_operand(cpu, JpOperands::NZ),
        ...
        0xC8 => instructions::jump::ret_with_operand(cpu, JpOperands::Z),
        0xC9 => instructions::jump::ret(cpu),
        ...
        0xD0 => instructions::jump::ret_with_operand(cpu, JpOperands::NC),
        ...
        0xD8 => instructions::jump::ret_with_operand(cpu, JpOperands::C),
        0xD9 => instructions::jump::reti(cpu),
